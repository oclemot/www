...
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsstring', 'page_list.tpl', 25, false),array('modifier', 'escapeurl', 'page_list.tpl', 32, false),)), $this); ?>
...
?>
            ...
            <?php else: ?>
                <li class="nav-header"><?php echo $this->_tpl_vars['Group']; ?>
</li>
            <?php endif; ?>
